...
public class KeyBoard2Fragment extends Fragment implements View.OnClickListener {

    OnKeyBoard2FragmentListener myListener;

    public interface OnKeyBoard2FragmentListener{
        void OnDoKeyBoard2FragmentListener(String msg, int type);
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_keyboard2, container, false);
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnKeyBoard2FragmentListener){
            myListener = (OnKeyBoard2FragmentListener) context;
        }
        else {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.key_button_0_4:
                myListener.OnDoKeyBoard2FragmentListener("", 2);
                break;
            ...
            case R.id.key_button_0_7:
                myListener.OnDoKeyBoard2FragmentListener("", 3);
                break;
            case R.id.key_button_1_0:
                myListener.OnDoKeyBoard2FragmentListener("a", 0);
                break;
            case R.id.key_button_1_1:
                myListener.OnDoKeyBoard2FragmentListener("b", 0);
                break;
            case R.id.key_button_1_2:
                myListener.OnDoKeyBoard2FragmentListener("c", 0);
                break;
            case R.id.key_button_1_3:
                myListener.OnDoKeyBoard2FragmentListener("d", 0);
                break;
            case R.id.key_button_1_4:
                myListener.OnDoKeyBoard2FragmentListener("e", 0);
                break;
            case R.id.key_button_1_5:
                myListener.OnDoKeyBoard2FragmentListener("f", 0);
                break;
            case R.id.key_button_1_6:
                myListener.OnDoKeyBoard2FragmentListener("g", 0);
                break;
            case R.id.key_button_1_7:
                myListener.OnDoKeyBoard2FragmentListener("h", 0);
                break;
            case R.id.key_button_2_0:
                myListener.OnDoKeyBoard2FragmentListener("i", 0);
                break;
            case R.id.key_button_2_1:
                myListener.OnDoKeyBoard2FragmentListener("j", 0);
                break;
            case R.id.key_button_2_2:
                myListener.OnDoKeyBoard2FragmentListener("k", 0);
                break;
            case R.id.key_button_2_3:
                myListener.OnDoKeyBoard2FragmentListener("l", 0);
                break;
            case R.id.key_button_2_4:
                myListener.OnDoKeyBoard2FragmentListener("m", 0);
                break;
            case R.id.key_button_2_5:
                myListener.OnDoKeyBoard2FragmentListener("n", 0);
                break;
            case R.id.key_button_2_6:
                myListener.OnDoKeyBoard2FragmentListener("o", 0);
                break;
            case R.id.key_button_2_7:
                myListener.OnDoKeyBoard2FragmentListener("p", 0);
                break;
            case R.id.key_button_3_0:
                myListener.OnDoKeyBoard2FragmentListener("q", 0);
                break;
            case R.id.key_button_3_1:
                myListener.OnDoKeyBoard2FragmentListener("r", 0);
                break;
            case R.id.key_button_3_2:
                myListener.OnDoKeyBoard2FragmentListener("s", 0);
                break;
            case R.id.key_button_3_3:
                myListener.OnDoKeyBoard2FragmentListener("t", 0);
                break;
            case R.id.key_button_3_4:
                myListener.OnDoKeyBoard2FragmentListener("u", 0);
                break;
            case R.id.key_button_3_5:
                myListener.OnDoKeyBoard2FragmentListener("v", 0);
                break;
            case R.id.key_button_3_6:
                myListener.OnDoKeyBoard2FragmentListener("w", 0);
                break;
            case R.id.key_button_3_7:
                myListener.OnDoKeyBoard2FragmentListener("x", 0);
                break;
            case R.id.key_button_4_0:
                myListener.OnDoKeyBoard2FragmentListener("y", 0);
                break;
            case R.id.key_button_4_1:
                myListener.OnDoKeyBoard2FragmentListener("z", 0);
                break;
            case R.id.key_button_4_2:
                myListener.OnDoKeyBoard2FragmentListener("", -1);
                break;
            case R.id.key_button_4_3:
                myListener.OnDoKeyBoard2FragmentListener("_{}", 5);
                break;
            case R.id.key_button_4_4:
                myListener.OnDoKeyBoard2FragmentListener("", 7);
                break;
            case R.id.key_button_4_5:
                myListener.OnDoKeyBoard2FragmentListener("...", 6);
                break;
